...
class ContactHeader: UICollectionReusableView {
    ...
    public func configureCell() {
        ...
        messageView.set(title: "The SEES Office is located in building 3, room 2123 and is open M-F from 8:00 AM-5:00 PM.", message: "The SEES Quiet Room is open 24/7 and the SEES Community Room is open at 8:00 AM and closes when the last person leaves.")
